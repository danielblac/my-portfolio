...
export default function Footer() {
  return (
    <footer className="h-14 gap-3 justify-center items-center text-lg border-t border-primary absolute p-4 bottom-0 flex w-full sm:h-16 sm:text-xl lg:h-20 lg:text-2xl">
      <p>© Daniel E.</p>
