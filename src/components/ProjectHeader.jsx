...
export default function ProjectHeader() {
  ...
  return (
    <>    
      <header className="flex flex-col p-4 items-center md:flex-row lg:p-6">
        <div className="flex w-full justify-between">
          ...
          <div 
            className='cursor-pointer md:hidden md:absolute' 
            onClick={toggleMenu}
          >
        ...
        <nav className={`${isOpen ? 'flex' : 'hidden'} text-sm sm:text-md pt-4 w-full justify-around md:flex md:text-lg md:justify-between lg:justify-around lg:text-xl xxl:text-2xl`}>
          <NavLink href='/'>
            <div className="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 sm:w-9 sm:h-9 md:hidden">
