      ...
      <div className="pb-14 px-2 xs:px-4">
        <h3 className='font-bold text-xl sm:text-2xl lg:text-3xl xxl:text-4xl'>Contact Me</h3>
          <div className="contact-details flex flex-col items-center pt-3">
            ...
            <p className='font-mono text-sm italic xs:text-lg sm:text-xl lg:pt-2 xl:text-2xl xl:pt-0'>Feel free to contact me on 👇</p>      
            <div className="social-icons w-10/12 text-md flex flex-col flex-wrap max-w-3xl justify-center gap-7 my-5 xs:my-9 xs:gap-9 xs:text-2xl sm:flex-row sm:w-full sm:text-3xl sm:gap-12 sm:my-10 lg:font-semibold lg:text-4xl lg:gap-x-16 xl:gap-x-20 xl:gap-y-10">
